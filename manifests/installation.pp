...
define oracle_java::installation (
  ...
  archive { "${custom_archive_path}/${filename}":
    cookie       => 'oraclelicense=accept-securebackup-cookie',
    source       => $downloadurl,
    cleanup      => true,
    require      => File["${custom_archive_path}/${longversion}"],
    extract      => true,
    extract_path => $custom_archive_path,
    creates      => "${custom_archive_path}/${longversion}"
  }

  # fix permissions
  file { "${custom_archive_path}/${longversion}":
    recurse  => true,
    owner    => 'root',
    group    => 'root',
    loglevel => debug
        ...
        case $type {
          'jdk'   : {
            exec { "add java alternative ${version_final}":
              command => "update-alternatives --install /usr/bin/java java ${custom_archive_path}/${longversion}/bin/java ${priority} \
                           --slave /usr/share/man/man1/java.1 java.1 ${custom_archive_path}/${longversion}/man/man1/java.1;
                          update-alternatives --install /usr/bin/javaws javaws ${custom_archive_path}/${longversion}/bin/javaws ${priority} \
                           --slave /usr/share/man/man1/javaws.1 javaws.1 ${custom_archive_path}/${longversion}/man/man1/javaws.1;
                          update-alternatives --install /usr/bin/jcontrol jcontrol ${custom_archive_path}/${longversion}/bin/jcontrol ${priority};
                          update-alternatives --install /usr/bin/jjs jjs ${custom_archive_path}/${longversion}/bin/jjs ${priority} \
                           --slave /usr/share/man/man1/jjs.1 jjs.1 ${custom_archive_path}/${longversion}/man/man1/jjs.1;
                          update-alternatives --install /usr/bin/keytool keytool ${custom_archive_path}/${longversion}/bin/keytool ${priority} \
                           --slave /usr/share/man/man1/keytool.1 keytool.1 ${custom_archive_path}/${longversion}/man/man1/keytool.1;
                          update-alternatives --install /usr/bin/orbd orbd ${custom_archive_path}/${longversion}/bin/orbd ${priority} \
                           --slave /usr/share/man/man1/orbd.1 orbd.1 ${custom_archive_path}/${longversion}/man/man1/orbd.1;
                          update-alternatives --install /usr/bin/pack200 pack200 ${custom_archive_path}/${longversion}/bin/pack200 ${priority} \
                           --slave /usr/share/man/man1/pack200.1 pack200.1 ${custom_archive_path}/${longversion}/man/man1/pack200.1;
                          update-alternatives --install /usr/bin/policytool policytool ${custom_archive_path}/${longversion}/bin/policytool ${priority} \
                           --slave /usr/share/man/man1/policytool.1 policytool.1 ${custom_archive_path}/${longversion}/man/man1/policytool.1;
                          update-alternatives --install /usr/bin/rmid rmid ${custom_archive_path}/${longversion}/bin/rmid ${priority} \
                           --slave /usr/share/man/man1/rmid.1 rmid.1 ${custom_archive_path}/${longversion}/man/man1/rmid.1;
                          update-alternatives --install /usr/bin/rmiregistry rmiregistry ${custom_archive_path}/${longversion}/bin/rmiregistry ${priority} \
                           --slave /usr/share/man/man1/rmiregistry.1 rmiregistry.1 ${custom_archive_path}/${longversion}/man/man1/rmiregistry.1;
                          update-alternatives --install /usr/bin/servertool servertool ${custom_archive_path}/${longversion}/bin/servertool ${priority} \
                           --slave /usr/share/man/man1/servertool.1 servertool.1 ${custom_archive_path}/${longversion}/man/man1/servertool.1;
                          update-alternatives --install /usr/bin/tnameserv tnameserv ${custom_archive_path}/${longversion}/bin/tnameserv ${priority} \
                           --slave /usr/share/man/man1/tnameserv.1 tnameserv.1 ${custom_archive_path}/${longversion}/man/man1/tnameserv.1;
                          update-alternatives --install /usr/bin/unpack200 unpack200 ${custom_archive_path}/${longversion}/bin/unpack200 ${priority} \
                           --slave /usr/share/man/man1/unpack200.1 unpack200.1 ${custom_archive_path}/${longversion}/man/man1/unpack200.1;
                          update-alternatives --install /usr/bin/appletviewer appletviewer ${custom_archive_path}/${longversion}/bin/appletviewer ${priority} \
                           --slave /usr/share/man/man1/appletviewer.1 appletviewer.1 ${custom_archive_path}/${longversion}/man/man1/appletviewer.1;
                          update-alternatives --install /usr/bin/extcheck extcheck ${custom_archive_path}/${longversion}/bin/extcheck ${priority} \
                           --slave /usr/share/man/man1/extcheck.1 extcheck.1 ${custom_archive_path}/${longversion}/man/man1/extcheck.1;
                          update-alternatives --install /usr/bin/idlj idlj ${custom_archive_path}/${longversion}/bin/idlj ${priority} \
                           --slave /usr/share/man/man1/idlj.1 idlj.1 ${custom_archive_path}/${longversion}/man/man1/idlj.1;
                          update-alternatives --install /usr/bin/jar jar ${custom_archive_path}/${longversion}/bin/jar ${priority} \
                           --slave /usr/share/man/man1/jar.1 jar.1 ${custom_archive_path}/${longversion}/man/man1/jar.1;
                          update-alternatives --install /usr/bin/jarsigner jarsigner ${custom_archive_path}/${longversion}/bin/jarsigner ${priority} \
                           --slave /usr/share/man/man1/jarsigner.1 jarsigner.1 ${custom_archive_path}/${longversion}/man/man1/jarsigner.1;
                          update-alternatives --install /usr/bin/javac javac ${custom_archive_path}/${longversion}/bin/javac ${priority} \
                           --slave /usr/share/man/man1/javac.1 javac.1 ${custom_archive_path}/${longversion}/man/man1/javac.1;
                          update-alternatives --install /usr/bin/javadoc javadoc ${custom_archive_path}/${longversion}/bin/javadoc ${priority} \
                           --slave /usr/share/man/man1/javadoc.1 javadoc.1 ${custom_archive_path}/${longversion}/man/man1/javadoc.1;
                          update-alternatives --install /usr/bin/javafxpackager javafxpackager ${custom_archive_path}/${longversion}/bin/javafxpackager ${priority} \
                           --slave /usr/share/man/man1/javafxpackager.1 javafxpackager.1 ${custom_archive_path}/${longversion}/man/man1/javafxpackager.1;
                          update-alternatives --install /usr/bin/javah javah ${custom_archive_path}/${longversion}/bin/javah ${priority} \
                           --slave /usr/share/man/man1/javah.1 javah.1 ${custom_archive_path}/${longversion}/man/man1/javah.1;
                          update-alternatives --install /usr/bin/javap javap ${custom_archive_path}/${longversion}/bin/javap ${priority} \
                           --slave /usr/share/man/man1/javap.1 javap.1 ${custom_archive_path}/${longversion}/man/man1/javap.1;
                          update-alternatives --install /usr/bin/javapackager javapackager ${custom_archive_path}/${longversion}/bin/javapackager ${priority} \
                           --slave /usr/share/man/man1/javapackager.1 javapackager.1 ${custom_archive_path}/${longversion}/man/man1/javapackager.1;
                          update-alternatives --install /usr/bin/java-rmi.cgi java-rmi.cgi ${custom_archive_path}/${longversion}/bin/java-rmi.cgi ${priority} \
                          update-alternatives --install /usr/bin/jcmd jcmd ${custom_archive_path}/${longversion}/bin/jcmd ${priority} \
                           --slave /usr/share/man/man1/jcmd.1 jcmd.1 ${custom_archive_path}/${longversion}/man/man1/jcmd.1;
                          update-alternatives --install /usr/bin/jconsole jconsole ${custom_archive_path}/${longversion}/bin/jconsole ${priority} \
                           --slave /usr/share/man/man1/jconsole.1 jconsole.1 ${custom_archive_path}/${longversion}/man/man1/jconsole.1;
                          update-alternatives --install /usr/bin/jdb jdb ${custom_archive_path}/${longversion}/bin/jdb ${priority} \
                           --slave /usr/share/man/man1/jdb.1 jdb.1 ${custom_archive_path}/${longversion}/man/man1/jdb.1;
                          update-alternatives --install /usr/bin/jdeps jdeps ${custom_archive_path}/${longversion}/bin/jdeps ${priority} \
                           --slave /usr/share/man/man1/jdeps.1 jdeps.1 ${custom_archive_path}/${longversion}/man/man1/jdeps.1;
                          update-alternatives --install /usr/bin/jhat jhat ${custom_archive_path}/${longversion}/bin/jhat ${priority} \
                           --slave /usr/share/man/man1/jhat.1 jhat.1 ${custom_archive_path}/${longversion}/man/man1/jhat.1;
                          update-alternatives --install /usr/bin/jinfo jinfo ${custom_archive_path}/${longversion}/bin/jinfo ${priority} \
                           --slave /usr/share/man/man1/jinfo.1 jinfo.1 ${custom_archive_path}/${longversion}/man/man1/jinfo.1;
                          update-alternatives --install /usr/bin/jmap jmap ${custom_archive_path}/${longversion}/bin/jmap ${priority} \
                           --slave /usr/share/man/man1/jmap.1 jmap.1 ${custom_archive_path}/${longversion}/man/man1/jmap.1;
                          update-alternatives --install /usr/bin/jmc jmc ${custom_archive_path}/${longversion}/bin/jmc ${priority} \
                           --slave /usr/share/man/man1/jmc.1 jmc.1 ${custom_archive_path}/${longversion}/man/man1/jmc.1;
                          update-alternatives --install /usr/bin/jps jps ${custom_archive_path}/${longversion}/bin/jps ${priority} \
                           --slave /usr/share/man/man1/jps.1 jps.1 ${custom_archive_path}/${longversion}/man/man1/jps.1;
                          update-alternatives --install /usr/bin/jrunscript jrunscript ${custom_archive_path}/${longversion}/bin/jrunscript ${priority} \
                           --slave /usr/share/man/man1/jrunscript.1 jrunscript.1 ${custom_archive_path}/${longversion}/man/man1/jrunscript.1;
                          update-alternatives --install /usr/bin/jsadebugd jsadebugd ${custom_archive_path}/${longversion}/bin/jsadebugd ${priority} \
                           --slave /usr/share/man/man1/jsadebugd.1 jsadebugd.1 ${custom_archive_path}/${longversion}/man/man1/jsadebugd.1;
                          update-alternatives --install /usr/bin/jstack jstack ${custom_archive_path}/${longversion}/bin/jstack ${priority} \
                           --slave /usr/share/man/man1/jstack.1 jstack.1 ${custom_archive_path}/${longversion}/man/man1/jstack.1;
                          update-alternatives --install /usr/bin/jstat jstat ${custom_archive_path}/${longversion}/bin/jstat ${priority} \
                           --slave /usr/share/man/man1/jstat.1 jstat.1 ${custom_archive_path}/${longversion}/man/man1/jstat.1;
                          update-alternatives --install /usr/bin/jstatd jstatd ${custom_archive_path}/${longversion}/bin/jstatd ${priority} \
                           --slave /usr/share/man/man1/jstatd.1 jstatd.1 ${custom_archive_path}/${longversion}/man/man1/jstatd.1;
                          update-alternatives --install /usr/bin/jvisualvm jvisualvm ${custom_archive_path}/${longversion}/bin/jvisualvm ${priority} \
                           --slave /usr/share/man/man1/jvisualvm.1 jvisualvm.1 ${custom_archive_path}/${longversion}/man/man1/jvisualvm.1;
                          update-alternatives --install /usr/bin/native2ascii native2ascii ${custom_archive_path}/${longversion}/bin/native2ascii ${priority} \
                           --slave /usr/share/man/man1/native2ascii.1 native2ascii.1 ${custom_archive_path}/${longversion}/man/man1/native2ascii.1;
                          update-alternatives --install /usr/bin/rmic rmic ${custom_archive_path}/${longversion}/bin/rmic ${priority} \
                           --slave /usr/share/man/man1/rmic.1 rmic.1 ${custom_archive_path}/${longversion}/man/man1/rmic.1;
                          update-alternatives --install /usr/bin/schemagen schemagen ${custom_archive_path}/${longversion}/bin/schemagen ${priority} \
                           --slave /usr/share/man/man1/schemagen.1 schemagen.1 ${custom_archive_path}/${longversion}/man/man1/schemagen.1;
                          update-alternatives --install /usr/bin/serialver serialver ${custom_archive_path}/${longversion}/bin/serialver ${priority} \
                           --slave /usr/share/man/man1/serialver.1 serialver.1 ${custom_archive_path}/${longversion}/man/man1/serialver.1;
                          update-alternatives --install /usr/bin/wsgen wsgen ${custom_archive_path}/${longversion}/bin/wsgen ${priority} \
                           --slave /usr/share/man/man1/wsgen.1 wsgen.1 ${custom_archive_path}/${longversion}/man/man1/wsgen.1;
                          update-alternatives --install /usr/bin/wsimport wsimport ${custom_archive_path}/${longversion}/bin/wsimport ${priority} \
                           --slave /usr/share/man/man1/wsimport.1 wsimport.1 ${custom_archive_path}/${longversion}/man/man1/wsimport.1;
                          update-alternatives --install /usr/bin/xjc xjc ${custom_archive_path}/${longversion}/bin/xjc ${priority} \
                           --slave /usr/share/man/man1/xjc.1 xjc.1 ${custom_archive_path}/${longversion}/man/man1/xjc.1"
            }
          }
          default : {
