...
define oracle_java::installation ($version = $name, $type = 'jre', $check_checksum = true, $add_alternative = false) {
  ...
  $filename = "${type}-${version_final}-linux-${arch}.tar.gz"
  ...
  archive { "/usr/java/${filename}":
    ...
    creates      => "/usr/java/${longversion}"
  } ->

  # fix permissions
  file { "/usr/java/${longversion}":
    recurse  => true,
    owner    => 'root',
    group    => 'root',
    loglevel => debug
        ...
        case $type {
          'jdk'   : {
            exec { "add java alternative ${version_final}":
              command => "update-alternatives --install /usr/bin/java java /usr/java/${longversion}/bin/java ${priority} \
                         --slave /usr/bin/appletviewer appletviewer /usr/java/${longversion}/bin/appletviewer \
                         --slave /usr/bin/extcheck extcheck /usr/java/${longversion}/bin/extcheck \
                         --slave /usr/bin/idlj idlj /usr/java/${longversion}/bin/idlj \
                         --slave /usr/bin/jar jar /usr/java/${longversion}/bin/jar \
                         --slave /usr/bin/jarsigner jarsigner /usr/java/${longversion}/bin/jarsigner \
                         --slave /usr/bin/javac javac /usr/java/${longversion}/bin/javac \
                         --slave /usr/bin/javadoc javadoc /usr/java/${longversion}/bin/javadoc \
                         --slave /usr/bin/javafxpackager javafxpackager /usr/java/${longversion}/bin/javafxpackager \
                         --slave /usr/bin/javah javah /usr/java/${longversion}/bin/javah \
                         --slave /usr/bin/javap javap /usr/java/${longversion}/bin/javap \
                         --slave /usr/bin/javapackager javapackager /usr/java/${longversion}/bin/javapackager \
                         --slave /usr/bin/java-rmi.cgi java-rmi.cgi /usr/java/${longversion}/bin/java-rmi.cgi \
                         --slave /usr/bin/javaws javaws /usr/java/${longversion}/bin/javaws \
                         --slave /usr/bin/jcmd jcmd /usr/java/${longversion}/bin/jcmd \
                         --slave /usr/bin/jconsole jconsole /usr/java/${longversion}/bin/jconsole \
                         --slave /usr/bin/jcontrol jcontrol /usr/java/${longversion}/bin/jcontrol \
                         --slave /usr/bin/jdb jdb /usr/java/${longversion}/bin/jdb \
                         --slave /usr/bin/jdeps jdeps /usr/java/${longversion}/bin/jdeps \
                         --slave /usr/bin/jhat jhat /usr/java/${longversion}/bin/jhat \
                         --slave /usr/bin/jinfo jinfo /usr/java/${longversion}/bin/jinfo \
                         --slave /usr/bin/jjs jjs /usr/java/${longversion}/bin/jjs \
                         --slave /usr/bin/jmap jmap /usr/java/${longversion}/bin/jmap \
                         --slave /usr/bin/jmc jmc /usr/java/${longversion}/bin/jmc \
                         --slave /usr/bin/jps jps /usr/java/${longversion}/bin/jps \
                         --slave /usr/bin/jrunscript jrunscript /usr/java/${longversion}/bin/jrunscript \
                         --slave /usr/bin/jsadebugd jsadebugd /usr/java/${longversion}/bin/jsadebugd \
                         --slave /usr/bin/jstack jstack /usr/java/${longversion}/bin/jstack \
                         --slave /usr/bin/jstat jstat /usr/java/${longversion}/bin/jstat \
                         --slave /usr/bin/jstatd jstatd /usr/java/${longversion}/bin/jstatd \
                         --slave /usr/bin/jvisualvm jvisualvm /usr/java/${longversion}/bin/jvisualvm \
                         --slave /usr/bin/keytool keytool /usr/java/${longversion}/bin/keytool \
                         --slave /usr/bin/native2ascii native2ascii /usr/java/${longversion}/bin/native2ascii \
                         --slave /usr/bin/orbd orbd /usr/java/${longversion}/bin/orbd \
                         --slave /usr/bin/pack200 pack200 /usr/java/${longversion}/bin/pack200 \
                         --slave /usr/bin/policytool policytool /usr/java/${longversion}/bin/policytool \
                         --slave /usr/bin/rmic rmic /usr/java/${longversion}/bin/rmic \
                         --slave /usr/bin/rmid rmid /usr/java/${longversion}/bin/rmid \
                         --slave /usr/bin/rmiregistry rmiregistry /usr/java/${longversion}/bin/rmiregistry \
                         --slave /usr/bin/schemagen schemagen /usr/java/${longversion}/bin/schemagen \
                         --slave /usr/bin/serialver serialver /usr/java/${longversion}/bin/serialver \
                         --slave /usr/bin/servertool servertool /usr/java/${longversion}/bin/servertool \
                         --slave /usr/bin/tnameserv tnameserv /usr/java/${longversion}/bin/tnameserv \
                         --slave /usr/bin/unpack200 unpack200 /usr/java/${longversion}/bin/unpack200 \
                         --slave /usr/bin/wsgen wsgen /usr/java/${longversion}/bin/wsgen \
                         --slave /usr/bin/wsimport wsimport /usr/java/${longversion}/bin/wsimport \
                         --slave /usr/bin/xjc xjc /usr/java/${longversion}/bin/xjc \
                         --slave /usr/share/man/man1/appletviewer.1 appletviewer.1 /usr/java/${longversion}/man/man1/appletviewer.1 \
                         --slave /usr/share/man/man1/extcheck.1 extcheck.1 /usr/java/${longversion}/man/man1/extcheck.1 \
                         --slave /usr/share/man/man1/idlj.1 idlj.1 /usr/java/${longversion}/man/man1/idlj.1 \
                         --slave /usr/share/man/man1/jar.1 jar.1 /usr/java/${longversion}/man/man1/jar.1 \
                         --slave /usr/share/man/man1/jarsigner.1 jarsigner.1 /usr/java/${longversion}/man/man1/jarsigner.1 \
                         --slave /usr/share/man/man1/java.1 java.1 /usr/java/${longversion}/man/man1/java.1 \
                         --slave /usr/share/man/man1/javac.1 javac.1 /usr/java/${longversion}/man/man1/javac.1 \
                         --slave /usr/share/man/man1/javadoc.1 javadoc.1 /usr/java/${longversion}/man/man1/javadoc.1 \
                         --slave /usr/share/man/man1/javafxpackager.1 javafxpackager.1 /usr/java/${longversion}/man/man1/javafxpackager.1 \
                         --slave /usr/share/man/man1/javah.1 javah.1 /usr/java/${longversion}/man/man1/javah.1 \
                         --slave /usr/share/man/man1/javap.1 javap.1 /usr/java/${longversion}/man/man1/javap.1 \
                         --slave /usr/share/man/man1/javapackager.1 javapackager.1 /usr/java/${longversion}/man/man1/javapackager.1 \
                         --slave /usr/share/man/man1/javaws.1 javaws.1 /usr/java/${longversion}/man/man1/javaws.1 \
                         --slave /usr/share/man/man1/jcmd.1 jcmd.1 /usr/java/${longversion}/man/man1/jcmd.1 \
                         --slave /usr/share/man/man1/jconsole.1 jconsole.1 /usr/java/${longversion}/man/man1/jconsole.1 \
                         --slave /usr/share/man/man1/jdb.1 jdb.1 /usr/java/${longversion}/man/man1/jdb.1 \
                         --slave /usr/share/man/man1/jdeps.1 jdeps.1 /usr/java/${longversion}/man/man1/jdeps.1 \
                         --slave /usr/share/man/man1/jhat.1 jhat.1 /usr/java/${longversion}/man/man1/jhat.1 \
                         --slave /usr/share/man/man1/jinfo.1 jinfo.1 /usr/java/${longversion}/man/man1/jinfo.1 \
                         --slave /usr/share/man/man1/jjs.1 jjs.1 /usr/java/${longversion}/man/man1/jjs.1 \
                         --slave /usr/share/man/man1/jmap.1 jmap.1 /usr/java/${longversion}/man/man1/jmap.1 \
                         --slave /usr/share/man/man1/jmc.1 jmc.1 /usr/java/${longversion}/man/man1/jmc.1 \
                         --slave /usr/share/man/man1/jps.1 jps.1 /usr/java/${longversion}/man/man1/jps.1 \
                         --slave /usr/share/man/man1/jrunscript.1 jrunscript.1 /usr/java/${longversion}/man/man1/jrunscript.1 \
                         --slave /usr/share/man/man1/jsadebugd.1 jsadebugd.1 /usr/java/${longversion}/man/man1/jsadebugd.1 \
                         --slave /usr/share/man/man1/jstack.1 jstack.1 /usr/java/${longversion}/man/man1/jstack.1 \
                         --slave /usr/share/man/man1/jstat.1 jstat.1 /usr/java/${longversion}/man/man1/jstat.1 \
                         --slave /usr/share/man/man1/jstatd.1 jstatd.1 /usr/java/${longversion}/man/man1/jstatd.1 \
                         --slave /usr/share/man/man1/jvisualvm.1 jvisualvm.1 /usr/java/${longversion}/man/man1/jvisualvm.1 \
                         --slave /usr/share/man/man1/keytool.1 keytool.1 /usr/java/${longversion}/man/man1/keytool.1 \
                         --slave /usr/share/man/man1/native2ascii.1 native2ascii.1 /usr/java/${longversion}/man/man1/native2ascii.1 \
                         --slave /usr/share/man/man1/orbd.1 orbd.1 /usr/java/${longversion}/man/man1/orbd.1 \
                         --slave /usr/share/man/man1/pack200.1 pack200.1 /usr/java/${longversion}/man/man1/pack200.1 \
                         --slave /usr/share/man/man1/policytool.1 policytool.1 /usr/java/${longversion}/man/man1/policytool.1 \
                         --slave /usr/share/man/man1/rmic.1 rmic.1 /usr/java/${longversion}/man/man1/rmic.1 \
                         --slave /usr/share/man/man1/rmid.1 rmid.1 /usr/java/${longversion}/man/man1/rmid.1 \
                         --slave /usr/share/man/man1/rmiregistry.1 rmiregistry.1 /usr/java/${longversion}/man/man1/rmiregistry.1 \
                         --slave /usr/share/man/man1/schemagen.1 schemagen.1 /usr/java/${longversion}/man/man1/schemagen.1 \
                         --slave /usr/share/man/man1/serialver.1 serialver.1 /usr/java/${longversion}/man/man1/serialver.1 \
                         --slave /usr/share/man/man1/servertool.1 servertool.1 /usr/java/${longversion}/man/man1/servertool.1 \
                         --slave /usr/share/man/man1/tnameserv.1 tnameserv.1 /usr/java/${longversion}/man/man1/tnameserv.1 \
                         --slave /usr/share/man/man1/unpack200.1 unpack200.1 /usr/java/${longversion}/man/man1/unpack200.1 \
                         --slave /usr/share/man/man1/wsgen.1 wsgen.1 /usr/java/${longversion}/man/man1/wsgen.1 \
                         --slave /usr/share/man/man1/wsimport.1 wsimport.1 /usr/java/${longversion}/man/man1/wsimport.1 \
                         --slave /usr/share/man/man1/xjc.1 xjc.1 /usr/java/${longversion}/man/man1/xjc.1"
            }
          }
          default : {
            exec { "add java alternative ${version_final}":
        ...
        case $type {
          'jdk'   : {
            exec { "add java alternative ${version_final}":
              command => "update-alternatives --install /usr/bin/java java /usr/java/${longversion}/bin/java ${priority} \
                           --slave /usr/share/man/man1/java.1 java.1 /usr/java/${longversion}/man/man1/java.1;
                          update-alternatives --install /usr/bin/javaws javaws /usr/java/${longversion}/bin/javaws ${priority} \
                           --slave /usr/share/man/man1/javaws.1 javaws.1 /usr/java/${longversion}/man/man1/javaws.1;
                          update-alternatives --install /usr/bin/jcontrol jcontrol /usr/java/${longversion}/bin/jcontrol ${priority};
                          update-alternatives --install /usr/bin/jjs jjs /usr/java/${longversion}/bin/jjs ${priority} \
                           --slave /usr/share/man/man1/jjs.1 jjs.1 /usr/java/${longversion}/man/man1/jjs.1;
                          update-alternatives --install /usr/bin/keytool keytool /usr/java/${longversion}/bin/keytool ${priority} \
                           --slave /usr/share/man/man1/keytool.1 keytool.1 /usr/java/${longversion}/man/man1/keytool.1;
                          update-alternatives --install /usr/bin/orbd orbd /usr/java/${longversion}/bin/orbd ${priority} \
                           --slave /usr/share/man/man1/orbd.1 orbd.1 /usr/java/${longversion}/man/man1/orbd.1;
                          update-alternatives --install /usr/bin/pack200 pack200 /usr/java/${longversion}/bin/pack200 ${priority} \
                           --slave /usr/share/man/man1/pack200.1 pack200.1 /usr/java/${longversion}/man/man1/pack200.1;
                          update-alternatives --install /usr/bin/policytool policytool /usr/java/${longversion}/bin/policytool ${priority} \
                           --slave /usr/share/man/man1/policytool.1 policytool.1 /usr/java/${longversion}/man/man1/policytool.1;
                          update-alternatives --install /usr/bin/rmid rmid /usr/java/${longversion}/bin/rmid ${priority} \
                           --slave /usr/share/man/man1/rmid.1 rmid.1 /usr/java/${longversion}/man/man1/rmid.1;
                          update-alternatives --install /usr/bin/rmiregistry rmiregistry /usr/java/${longversion}/bin/rmiregistry ${priority} \
                           --slave /usr/share/man/man1/rmiregistry.1 rmiregistry.1 /usr/java/${longversion}/man/man1/rmiregistry.1;
                          update-alternatives --install /usr/bin/servertool servertool /usr/java/${longversion}/bin/servertool ${priority} \
                           --slave /usr/share/man/man1/servertool.1 servertool.1 /usr/java/${longversion}/man/man1/servertool.1;
                          update-alternatives --install /usr/bin/tnameserv tnameserv /usr/java/${longversion}/bin/tnameserv ${priority} \
                           --slave /usr/share/man/man1/tnameserv.1 tnameserv.1 /usr/java/${longversion}/man/man1/tnameserv.1;
                          update-alternatives --install /usr/bin/unpack200 unpack200 /usr/java/${longversion}/bin/unpack200 ${priority} \
                           --slave /usr/share/man/man1/unpack200.1 unpack200.1 /usr/java/${longversion}/man/man1/unpack200.1;
                          update-alternatives --install /usr/bin/appletviewer appletviewer /usr/java/${longversion}/bin/appletviewer ${priority} \
                           --slave /usr/share/man/man1/appletviewer.1 appletviewer.1 /usr/java/${longversion}/man/man1/appletviewer.1;
                          update-alternatives --install /usr/bin/extcheck extcheck /usr/java/${longversion}/bin/extcheck ${priority} \
                           --slave /usr/share/man/man1/extcheck.1 extcheck.1 /usr/java/${longversion}/man/man1/extcheck.1;
                          update-alternatives --install /usr/bin/idlj idlj /usr/java/${longversion}/bin/idlj ${priority} \
                           --slave /usr/share/man/man1/idlj.1 idlj.1 /usr/java/${longversion}/man/man1/idlj.1;
                          update-alternatives --install /usr/bin/jar jar /usr/java/${longversion}/bin/jar ${priority} \
                           --slave /usr/share/man/man1/jar.1 jar.1 /usr/java/${longversion}/man/man1/jar.1;
                          update-alternatives --install /usr/bin/jarsigner jarsigner /usr/java/${longversion}/bin/jarsigner ${priority} \
                           --slave /usr/share/man/man1/jarsigner.1 jarsigner.1 /usr/java/${longversion}/man/man1/jarsigner.1;
                          update-alternatives --install /usr/bin/javac javac /usr/java/${longversion}/bin/javac ${priority} \
                           --slave /usr/share/man/man1/javac.1 javac.1 /usr/java/${longversion}/man/man1/javac.1;
                          update-alternatives --install /usr/bin/javadoc javadoc /usr/java/${longversion}/bin/javadoc ${priority} \
                           --slave /usr/share/man/man1/javadoc.1 javadoc.1 /usr/java/${longversion}/man/man1/javadoc.1;
                          update-alternatives --install /usr/bin/javafxpackager javafxpackager /usr/java/${longversion}/bin/javafxpackager ${priority} \
                           --slave /usr/share/man/man1/javafxpackager.1 javafxpackager.1 /usr/java/${longversion}/man/man1/javafxpackager.1;
                          update-alternatives --install /usr/bin/javah javah /usr/java/${longversion}/bin/javah ${priority} \
                           --slave /usr/share/man/man1/javah.1 javah.1 /usr/java/${longversion}/man/man1/javah.1;
                          update-alternatives --install /usr/bin/javap javap /usr/java/${longversion}/bin/javap ${priority} \
                           --slave /usr/share/man/man1/javap.1 javap.1 /usr/java/${longversion}/man/man1/javap.1;
                          update-alternatives --install /usr/bin/javapackager javapackager /usr/java/${longversion}/bin/javapackager ${priority} \
                           --slave /usr/share/man/man1/javapackager.1 javapackager.1 /usr/java/${longversion}/man/man1/javapackager.1;
                          update-alternatives --install /usr/bin/java-rmi.cgi java-rmi.cgi /usr/java/${longversion}/bin/java-rmi.cgi ${priority} \
                          update-alternatives --install /usr/bin/jcmd jcmd /usr/java/${longversion}/bin/jcmd ${priority} \
                           --slave /usr/share/man/man1/jcmd.1 jcmd.1 /usr/java/${longversion}/man/man1/jcmd.1;
                          update-alternatives --install /usr/bin/jconsole jconsole /usr/java/${longversion}/bin/jconsole ${priority} \
                           --slave /usr/share/man/man1/jconsole.1 jconsole.1 /usr/java/${longversion}/man/man1/jconsole.1;
                          update-alternatives --install /usr/bin/jdb jdb /usr/java/${longversion}/bin/jdb ${priority} \
                           --slave /usr/share/man/man1/jdb.1 jdb.1 /usr/java/${longversion}/man/man1/jdb.1;
                          update-alternatives --install /usr/bin/jdeps jdeps /usr/java/${longversion}/bin/jdeps ${priority} \
                           --slave /usr/share/man/man1/jdeps.1 jdeps.1 /usr/java/${longversion}/man/man1/jdeps.1;
                          update-alternatives --install /usr/bin/jhat jhat /usr/java/${longversion}/bin/jhat ${priority} \
                           --slave /usr/share/man/man1/jhat.1 jhat.1 /usr/java/${longversion}/man/man1/jhat.1;
                          update-alternatives --install /usr/bin/jinfo jinfo /usr/java/${longversion}/bin/jinfo ${priority} \
                           --slave /usr/share/man/man1/jinfo.1 jinfo.1 /usr/java/${longversion}/man/man1/jinfo.1;
                          update-alternatives --install /usr/bin/jmap jmap /usr/java/${longversion}/bin/jmap ${priority} \
                           --slave /usr/share/man/man1/jmap.1 jmap.1 /usr/java/${longversion}/man/man1/jmap.1;
                          update-alternatives --install /usr/bin/jmc jmc /usr/java/${longversion}/bin/jmc ${priority} \
                           --slave /usr/share/man/man1/jmc.1 jmc.1 /usr/java/${longversion}/man/man1/jmc.1;
                          update-alternatives --install /usr/bin/jps jps /usr/java/${longversion}/bin/jps ${priority} \
                           --slave /usr/share/man/man1/jps.1 jps.1 /usr/java/${longversion}/man/man1/jps.1;
                          update-alternatives --install /usr/bin/jrunscript jrunscript /usr/java/${longversion}/bin/jrunscript ${priority} \
                           --slave /usr/share/man/man1/jrunscript.1 jrunscript.1 /usr/java/${longversion}/man/man1/jrunscript.1;
                          update-alternatives --install /usr/bin/jsadebugd jsadebugd /usr/java/${longversion}/bin/jsadebugd ${priority} \
                           --slave /usr/share/man/man1/jsadebugd.1 jsadebugd.1 /usr/java/${longversion}/man/man1/jsadebugd.1;
                          update-alternatives --install /usr/bin/jstack jstack /usr/java/${longversion}/bin/jstack ${priority} \
                           --slave /usr/share/man/man1/jstack.1 jstack.1 /usr/java/${longversion}/man/man1/jstack.1;
                          update-alternatives --install /usr/bin/jstat jstat /usr/java/${longversion}/bin/jstat ${priority} \
                           --slave /usr/share/man/man1/jstat.1 jstat.1 /usr/java/${longversion}/man/man1/jstat.1;
                          update-alternatives --install /usr/bin/jstatd jstatd /usr/java/${longversion}/bin/jstatd ${priority} \
                           --slave /usr/share/man/man1/jstatd.1 jstatd.1 /usr/java/${longversion}/man/man1/jstatd.1;
                          update-alternatives --install /usr/bin/jvisualvm jvisualvm /usr/java/${longversion}/bin/jvisualvm ${priority} \
                           --slave /usr/share/man/man1/jvisualvm.1 jvisualvm.1 /usr/java/${longversion}/man/man1/jvisualvm.1;
                          update-alternatives --install /usr/bin/native2ascii native2ascii /usr/java/${longversion}/bin/native2ascii ${priority} \
                           --slave /usr/share/man/man1/native2ascii.1 native2ascii.1 /usr/java/${longversion}/man/man1/native2ascii.1;
                          update-alternatives --install /usr/bin/rmic rmic /usr/java/${longversion}/bin/rmic ${priority} \
                           --slave /usr/share/man/man1/rmic.1 rmic.1 /usr/java/${longversion}/man/man1/rmic.1;
                          update-alternatives --install /usr/bin/schemagen schemagen /usr/java/${longversion}/bin/schemagen ${priority} \
                           --slave /usr/share/man/man1/schemagen.1 schemagen.1 /usr/java/${longversion}/man/man1/schemagen.1;
                          update-alternatives --install /usr/bin/serialver serialver /usr/java/${longversion}/bin/serialver ${priority} \
                           --slave /usr/share/man/man1/serialver.1 serialver.1 /usr/java/${longversion}/man/man1/serialver.1;
                          update-alternatives --install /usr/bin/wsgen wsgen /usr/java/${longversion}/bin/wsgen ${priority} \
                           --slave /usr/share/man/man1/wsgen.1 wsgen.1 /usr/java/${longversion}/man/man1/wsgen.1;
                          update-alternatives --install /usr/bin/wsimport wsimport /usr/java/${longversion}/bin/wsimport ${priority} \
                           --slave /usr/share/man/man1/wsimport.1 wsimport.1 /usr/java/${longversion}/man/man1/wsimport.1;
                          update-alternatives --install /usr/bin/xjc xjc /usr/java/${longversion}/bin/xjc ${priority} \
                           --slave /usr/share/man/man1/xjc.1 xjc.1 /usr/java/${longversion}/man/man1/xjc.1"
            }
          }
          default : {
